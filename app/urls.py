...
urlpatterns = [
    ...
    # path('cart/delete_cart/<int:cart_id>',views.delete_cart,name='delete_cart'),
    ...
    path('products_page/<slug:category>/', views.products_page, name='product'),  # The base URL without a specific brand
    path('products_page/<slug:category>/<slug:data>/', views.products_page, name='productdata'),  # The URL with a specific brand as a slug
    ...
    path('checkout/<slug:type>', views.checkout, name='checkout'),
