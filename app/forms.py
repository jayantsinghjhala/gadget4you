...
class MyPasswordResetForm(PasswordResetForm):
     email=forms.EmailField(label=_("Recovery Email"),max_length=254,widget=forms.EmailInput(attrs={'autocomplete':'email','autofocus':True,'class':'form-control'}))
...
class CustomerProfileForm(forms.ModelForm):
     class Meta:
          ...
          'state':forms.Select(attrs={'class':'form-control','placeholder':'Select State'}),
